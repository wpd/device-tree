...
#define WR08(a, d)	 __asm__("\teieio\n");(*((volatile byte *) (a)) = d); __asm__("\teieio\n")
#define WR16(a, d)	 __asm__("\teieio\n");(*((volatile ui16 *) (a)) = d); __asm__("\teieio\n")
#define WR32(a, d)	 __asm__("\teieio\n");(*((volatile ui32 *) (a)) = d); __asm__("\teieio\n")

//----------------------------------------------------------------------------

#define MEM_RD08(a)		(*((byte *)((ui32)(a))))
#define MEM_WR08(a, d)	 __asm__("\teieio\n");	*((byte *)((ui32)(a))) = d; __asm__("\teieio\n")

#define MEM_RD16(a)		(*((ui16 *)((ui32)(a))))
#define MEM_WR16(a, d)	 __asm__("\teieio\n");	*((ui16 *)((ui32)(a))) = d; __asm__("\teieio\n")

#define MEM_RD32(a)		(*((ui32 *)((ui32)(a))))
#define MEM_WR32(a, d)	 __asm__("\teieio\n");	*((ui32 *)((ui32)(a))) = d; __asm__("\teieio\n")
