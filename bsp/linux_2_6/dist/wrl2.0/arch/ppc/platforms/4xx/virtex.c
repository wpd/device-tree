...
struct platform_device xilinx_uartlite_0_device = XPAR_UARTLITE(0);
#endif
#if defined(XPAR_UARTLITE_1_BASEADDR)
struct platform_device xilinx_uartlite_1_device = XPAR_UARTLITE(1);
#endif
#if defined(XPAR_UARTLITE_2_BASEADDR)
struct platform_device xilinx_uartlite_2_device = XPAR_UARTLITE(2);
#endif
#if defined(XPAR_UARTLITE_3_BASEADDR)
struct platform_device xilinx_uartlite_3_device = XPAR_UARTLITE(3);
#endif
#if defined(XPAR_UARTLITE_4_BASEADDR)
#error Edit this file to add more uartlite devices.
#endif			/* 4 */
...
#if defined(XPAR_UARTLITE_0_BASEADDR)
	platform_device_register(&xilinx_uartlite_0_device);
#endif
#if defined(XPAR_UARTLITE_1_BASEADDR)
	platform_device_register(&xilinx_uartlite_1_device);
#endif
#if defined(XPAR_UARTLITE_2_BASEADDR)
	platform_device_register(&xilinx_uartlite_2_device);
#endif
#if defined(XPAR_UARTLITE_3_BASEADDR)
	platform_device_register(&xilinx_uartlite_3_device);
#endif
